...
import { Link } from 'react-router-dom';
 ...
 class ArchitectureDetails extends Component {
    ...
    constructor(props) {
      ...
      componentDidMount() {
          ...
          console.log("we are here " + AppUrl.ArchitectureDetails + architectureId);
     
    
        RestClient.GetRequest(AppUrl.ArchitectureDetails + architectureId).then((result) => {
    
          
      
    
            this.setState({
                architecture_image: result[0]['architecture_image'],
                short_desc: result[0]['short_desc'],
                long_title: result[0]['long_title'],
                long_desc: result[0]['long_desc'],
                architecture_image2: result[0]['architecture_image2'],
                date: result[0]['date'],
      ...
      <div class="slides-1 portfolio-details-slider swiper">
        <div class="swiper-wrapper align-items-center">
          ...
          <div class="swiper-slide">
            <img src={this.state.architecture_image} alt=""/>
          </div>
          <div class="swiper-slide">
            <img src={this.state.architecture_image2}  alt=""/>
          </div>
        </div>
    ...
    <div class="row justify-content-between gy-4 mt-4">
      ...
      <div class="col-lg-3">
        <div class="portfolio-info">
          ...
          <ul>
            <li><strong>Category</strong> <span>Architecture Photography</span></li>

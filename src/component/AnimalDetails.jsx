...
import { Link } from 'react-router-dom';
 ...
 class AnimalDetails extends Component {
  ...
  componentDidMount() {
      ...
      console.log("we are here " + AppUrl.AnimalDetails + animalId);
 

    RestClient.GetRequest(AppUrl.AnimalDetails + animalId).then((result) => {
    ...
    <div class="slides-1 portfolio-details-slider swiper">
      <div class="swiper-wrapper align-items-center">
        ...
        <div class="swiper-slide">
          <img src={this.state.animal_image} alt=""/>
        </div>
        <div class="swiper-slide">
          <img src={this.state.animal_image2}  alt=""/>
        </div>
      </div>
  ...
  <div class="row justify-content-between gy-4 mt-4">
    ...
    <div class="col-lg-3">
      <div class="portfolio-info">
        ...
        <ul>
          <li><strong>Category</strong> <span>Animal Photography</span></li>

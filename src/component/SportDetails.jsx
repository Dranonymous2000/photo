 ...
 class SportDetails extends Component {
    ...
    constructor(props) {
      ...
      componentDidMount() {
          ...
          const sportId = pathParts[pathParts.length - 1];
    
          console.log("we are here " + AppUrl.SportDetails + sportId);
     
    
        RestClient.GetRequest(AppUrl.SportDetails + sportId).then((result) => {
      ...
      <div class="slides-1 portfolio-details-slider swiper">
        <div class="swiper-wrapper align-items-center">
          ...
          <div class="swiper-slide">
            <img src={this.state.sport_image} alt=""/>
          </div>
          <div class="swiper-slide">
            <img src={this.state.sport_image2}  alt=""/>
          </div>
        </div>
    ...
    <div class="row justify-content-between gy-4 mt-4">
      ...
      <div class="col-lg-3">
        <div class="portfolio-info">
          ...
          <ul>
            <li><strong>Category</strong> <span>Sport Photography</span></li>
